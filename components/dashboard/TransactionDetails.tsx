...
const TransactionDetails: React.FC = () => {
  return (
    <article className="p-6 sm:p-8 mb-8 bg-white rounded-2xl sm:rounded-3xl shadow-sm">
      ...
      <div className="flex gap-2.5 items-center p-3 sm:p-4 rounded-xl bg-orange-100">
        <span className="bg-orange-500 rounded-full h-2 w-2" />
        <p className="text-sm sm:text-base lg:text-lg tracking-tight text-orange-800">Awaiting response from Client</p>
      </div>
    </article>
  )
}
