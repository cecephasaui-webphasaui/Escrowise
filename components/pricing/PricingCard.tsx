  ...
  return (
    <article className="flex flex-col h-full rounded-xl sm:rounded-3xl bg-[#EDE9DD] overflow-hidden transition-all hover:shadow-lg">
      <div className="flex flex-col flex-grow p-6 sm:p-8">
        ...
        <button className="mt-8 px-6 py-3 sm:py-4 text-base font-bold tracking-tighter text-white bg-orange-400 hover:bg-orange-500 transition-colors rounded-md w-full">
          Choose Plan
        </button>
      </div>
      ...
      <div className="p-4 sm:p-6 bg-[#9F9F9F] text-sm sm:text-base tracking-tighter text-black">
        <div className="flex gap-3 items-start">
          <p>
            No time limit. You only pay when you use our escrow services, with no recurring fees or hidden costs.
            This ensures that businesses and individuals only pay for what they need, when they need it.
          </p>
          <svg
            width="20"
            height="20"
