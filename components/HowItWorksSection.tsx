  ...
  return (
    <section className="w-full max-w-7xl mx-auto py-12 sm:py-16 lg:py-24 px-4 sm:px-0">
      <div className="text-center mb-12 sm:mb-16">
        <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold tracking-tighter text-black mb-4 sm:mb-5 max-w-4xl mx-auto px-4">
          With over 7.5 billion of transactions protected with Escrowise
        </h2>
        <p className="text-base sm:text-lg lg:text-xl tracking-tighter text-black max-w-3xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 lg:gap-7">
        <ProcessStep
          ...
          bgClass="bg-amber-400 bg-opacity-20"
        />
        <ProcessStep
