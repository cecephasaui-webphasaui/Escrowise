        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="col-span-1 lg:col-span-1">
            <FooterColumn
              ...
              links={["Bitcoin & Cryptocurrency Escrow", "Real Estate Escrow", "Financial Escrow", "Broker Escrow"]}
            />
          </div>
          ...
          <div className="col-span-1 lg:col-span-1">
            <FooterColumn
              ...
              links={["Help Center", "Contact Us", "How It Works", "Security & Compliance"]}
            />
          </div>
          ...
          <div className="col-span-1 sm:col-span-1 lg:col-span-1">
            <FooterColumn
              ...
              links={["Terms of Service", "Privacy Policy", "Regulatory Compliance", "AML & KYC Policy"]}
            />
          </div>
